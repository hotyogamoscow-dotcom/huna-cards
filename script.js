...
const theoryData = [
	{
    	...
    	title: "1",
    	sub: ``,
    	content: `Алакаи (помощник) должен был получить посвящение на высшие уровни... (текст сокращен для экономии места в ответе, используйте свой оригинал)`
	},
    // ... (все остальные элементы theoryData из вашего оригинала)
];

// Для корректной работы я предполагаю, что вы скопируете весь массив theoryData и interpretationsData из своего исходного файла.
...
function displayCard(data) {
   ...
   if (currentMode === 'interpretations') {
   	...
   	cardComment.parentElement.style.display = data.comment ? "block" : "none";
   }
